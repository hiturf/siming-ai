...
export const PERMISSION_PACKS: PermissionPack[] = [
  {
    ...
    tools: ['list_projects', 'get_project_info', 'search_chapters', 'search_characters', 'search_worldbuilding', 'search_outline', 'search_context', 'prepare_external_writing_context', 'inspect_story_granularity', 'list_chapter_versions', 'diff_chapter_versions'],
    riskLevel: 'safe',
  },
  {
